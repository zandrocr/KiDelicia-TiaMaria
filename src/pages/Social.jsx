...
//img
import Table from '../image/tableFood.jpg'
//hook
...
const Social = () => {
    ...
    return ( <div className="social col-12 d-flex flex-column align-items-center justify-content-between">
        ...
        <a href="https://api.whatsapp.com/send?phone=5512988656155&text=Ol%C3%A1%2C%20gostaria%20de%20saber%20sobre%20os%20seus%20servi%C3%A7os" target="_blank" className='whats col-3 col-md-1 d-flex justify-content-around' data-aos="fade-down" data-aos-duration="2000" data-aos-offset="90">
        </a>
        <p className='project'>
